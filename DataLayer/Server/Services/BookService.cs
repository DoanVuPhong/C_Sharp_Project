...
namespace Server.Services
{
    public class BookService
    {
        ...
        public static DataTable CustomSearch(string ISBN, string bookName, string authorName)
        {
            ...
            Query = "Select b.ID, b.ISBN, b.name As 'Name', b.price as 'Price', b.quantity as'Quantity', b.year as 'Year', a.name as'Author' From Book b, Book_Author ba , Author a Where b.ISBN = @ISBN  AND ba.book_ID = b.ID AND ba.author_ID = a.ID  AND b.Quantity >0";
            SqlCommand cmd = new SqlCommand(Query, conn);
            cmd.Parameters.AddWithValue("@ISBN", ISBN);
            if (string.IsNullOrEmpty(ISBN))
            {
                Query = "Select b.ID, b.ISBN, b.name As 'Name', b.price as 'Price', b.quantity as'Quantity', b.year as 'Year', a.name as'Author' From Book b, Book_Author ba , Author a Where b.name like @BookName AND a.name like @BookAuthor AND ba.book_ID = b.ID AND ba.author_ID = a.ID AND b.Quantity >0";
